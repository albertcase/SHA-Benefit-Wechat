	...
	<div style="text-align:center" >
		<form id="SystemWmenuAddEventForm" method="post" action="">
			<table style="width:100%;text-align:center" cellspacing="0" summary="The technical specifications of the Apple PowerMac G5 series">
				...
				<tr>
					...
					<td style="text-align:left" class="row">
						<input class="easyui-combobox" name="SystemWmenuAddEventMsgtype" id="SystemWmenuAddEventMsgtype" data-options='  
								valueField: "id",
								textField: "name",
								data: [{id:"text",name:"文本"},{id:"news",name:"图文"},{id:"pic",name:"图片"}],
								onSelect: function(record){
									if(record.id=="text"){
										$("#SystemWmenuAddEventTextArea").show();
										$("#SystemWmenuAddEventNewsArea").hide();
										$("#SystemWmenuAddEventPicArea").hide();
										...
										$("#SystemWmenuAddEventTextArea").hide();
										$("#SystemWmenuAddEventNewsArea").hide();
										$("#SystemWmenuAddEventPicArea").show();
									}
								},
								onLoadSuccess:function(){
				...
				<tbody id="SystemWmenuAddEventPicArea" style="display:none">
				<tr>
					<td style="text-align:right;" class="row">图文消息图片：</td>
					<td style="text-align:left;" class="row">
						<div id="SystemWmenuAddEventBimgShowArea">
							<img src="" id="SystemWmenuAddEventBimgShow" width="100px">
						</div>
						<div id="SystemWmenuAddEventBimgBut" style="width:120px">
							<div id="SystemWmenuAddEventBimgProcessing" style="display:none">
								<img id="SystemWmenuAddEventBimgShow" src="<?php echo $baseUrl?>/images/system/processing.gif" style="width: 20px;">
							</div>
							<div id="SystemWmenuAddEventBimgButText" style="padding:10px 0 10px 0;"><a href="javascript:void(0)" class="easyui-linkbutton" >点击上传图片</a></div>
						</div>
						<input type="hidden" value="" name="SystemWmenuAddEventBimg" id="SystemWmenuAddEventBimg">
					</td>
				</tr>
				</tbody>
				<tr>
...
<!--
	var systemWmenuAddEvent = {
		init:function(){
			...
			systemWmenuAddEvent.createUploader('SystemWmenuAddEventBimg');
		},
		submitForm:function(){			
			var formdata = {
				...
				bpicUrl : $("#SystemWmenuAddEventBimg").val()
			}
